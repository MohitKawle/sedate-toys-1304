...
const Restaurants = () => {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.value === "lth") {
            Reslist.sort((a, b) => { return Number(a.rating) - Number(b.rating) });
        }
        else if (e.target.value === "htl") {
            Reslist.sort((a, b) => { return Number(b.rating) - Number(a.rating) });
        }
    }
                ...
                <div className={styles.resDiv}>
                    ...
                    <div className={styles.resListingDiv}>
                        ...
                        {Reslist.map((rest, ind) => {
                            ...
                            return <div key={rest.id} className={styles.res}>
                                <div className={styles.resPic}>
                                    <img src={rest.srcImg} className={styles.imgRes} alt="hotel_photo" />
                                </div>
                                <div className={styles.aboutResDiv}>
                                    <div className={styles.ResName}>{ind + 1}.{rest.name}</div>
                                    ...
                                    <div className={styles.typeDiv}><p>{rest.type}</p></div>
            ...
            <div className={styles.faq}>
                ...
                <Accordion allowToggle width="xxl">
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                            Some of the most popular restaurants in Pune that provide takeaway are:
                            <ul>
                                <li>Spice Kitchen</li>
                                <li>Alto Vino</li>
                                <li>Mosaic</li>
                    ...
                    <AccordionItem>
                        <h2>
                            <AccordionButton>
                                <Box flex='1' textAlign='left' fontWeight="bold">
                                    What are the best restaurants in Pune for families with children?
                                </Box>
                                <AccordionIcon />
                            </AccordionButton>
                        </h2>
                        <AccordionPanel pb={4}>
                            Some of the best restaurants in Pune for families with children include:
                            <ul>
                                <li>The Market</li>
                                <li>Feast</li>
                                <li>Spice Kitchen</li>
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                            Some of the most popular restaurants in Pune for cheap eats include:
                            <ul>
