...
const TopAttraction = () => {
	const TAdata = [
		...
		},
		{
			...
			category: "Garden",
			review:"The first garden which develop on the base of Japanese Garden theme.",
			list: [
		...
		},
		{
			...
			category: "Temples",
			review:"A 600 year old religious institution, Sri Balaji Mandir is built as a replica of the famous Tirumala Balaji Temple in…",
			list: [
		...
		},
		{
			...
			review:"Ganesh, second son of Lord Shiva (one of the 3 Gods of Hindu trinity) & and His consort Goddess Parvati, is situated…",
			category: "Temples",
			list: [
