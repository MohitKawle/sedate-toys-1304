      ...
      <div className={navbar.divright2}>
        <div className={navbar.flex_logo}>
          <div className={navbar.logo_img}>
            <img src="https://th.bing.com/th/id/R.841c81b65e06c00c4860ac66074b3a8d?rik=LcQg2sgre%2bdIbA&riu=http%3a%2f%2fcdn.onlinewebfonts.com%2fsvg%2fimg_335398.png&ehk=bk9TqWvYTBPnOlKBTPBlDO4EgUm9VZJwyG8WxaMDPVs%3d&risl=&pid=ImgRaw&r=0" alt="" />

          </div>Review</div>

        <div className={navbar.flex_logo}>
          <div className={navbar.logo_img}>
            <img src="https://th.bing.com/th/id/R.32e9c6b871e84b6a7bdcf048f75eeeab?rik=fr0fBu%2f7LT231A&riu=http%3a%2f%2fcdn.onlinewebfonts.com%2fsvg%2fimg_573021.png&ehk=ceKDjla8U6WJMf5cgPcLF8U59RdrAaTk9aaxIfPlPr4%3d&risl=&pid=ImgRaw&r=0" alt="" />

          </div>Trips</div>
          <div className={navbar.flex_logo}>
          <div className={navbar.logo_img}>
            <img src="https://image.freepik.com/free-icon/small-bell_318-10933.jpg" alt="" />
