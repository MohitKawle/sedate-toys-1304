      ...
      >
        ...
        >
          ...
          <Box display={"flex"} gap={"10px"} marginTop={"10px"}>
            <Box><i className="fa-solid fa-lock"></i></Box>
...
{/* Cardholder Name Added */}
          <Box>
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>Cardholder Name  <Text color={"red"}> *</Text></Text>
...
{/* Credit/debit card number */}
          <Box>
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>Credit/debit card number  <Text color={"red"}> *</Text></Text>
          <Input marginTop={"10px"} 
          width={"340px"} 
          height={"44px"}  
          type={"Number"} 
          ...
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>Expiration date  <Text color={"red"}> *</Text></Text>
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>CVC Code   <Text color={"red"}> *</Text></Text>
          </Box>
          <Box display={"flex"} gap={"10px"} marginTop={"10px"}>
          ...
          <Text color={"grey"} marginTop="10px" fontSize={"13px"}>{<Icon />} What is this?</Text>
          </Box>
 {/* Billing Address */}
          <Text fontSize={"24px"}
              fontWeight={"700"}
          ...
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>Country  <Text color={"red"}> *</Text></Text>
          <Text fontWeight={"bold"} display={"flex"} marginTop={"20px"}>Postal/Zip Code   <Text color={"red"}> *</Text></Text>
          </Box>
...
<Box
         ...
         >
          ...
          <Box padding={"20px"}>
            <Box  display={"flex"} gap={"20px"} marginTop={"10px"}>
              <Box fontSize={"25px"}><i className="fa-solid fa-wallet"></i></Box>
              <Box>
            ...
            <Box  display={"flex"} gap={"20px"} marginTop={"10px"}>
              <Box fontSize={"25px"}><i className="fa-solid fa-lock"></i></Box>
              <Box>
            ...
            <Box  display={"flex"} gap={"20px"} marginTop={"10px"}>
              <Box fontSize={"25px"}><i className="fa-solid fa-headphones"></i></Box>
              <Box>
            ...
            <Box  display={"flex"} gap={"20px"} marginTop={"10px"}>
              <Box fontSize={"25px"}><i className="fa-solid fa-phone"></i></Box>
              <Box>
     ...
     <Text marginTop={"20px"} 
      ...
      color={"grey"}
      textAlign={"center"}
      >© 2022 TripAdvisor LLC All rights reserved. Tripadvisor <Link to="#" color={"#188ead"}>Terms of Use</Link> and <Link to="#" color={"#188ead"} >Privacy Policy</Link>.</Text>
     </Box>
    </Box>
  )
}
