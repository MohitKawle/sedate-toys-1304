        ...
        <Accordion allowToggle width="xxl">
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              9196 Suyog Inn are some of the most popular hotels for travellers
              looking to stay near Dagadusheth Halwai Ganapati Temple. See the
              full list: Hotels near Dagadusheth Halwai Ganapati Temple.
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              The Corinthians Resort & Club, Atmantan Wellness Resort, and Green
              Gate Resort are all popular resorts for travellers staying in
              Pune. See the full list: Pune Resorts.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
            ...
            <AccordionPanel pb={4}>
              ...
              Centurion Spring Hills Holiday Resort, and Ambrosia Resort & Spa.
              See the full list: Hotels near Sinhagad Fort.
            </AccordionPanel>
          </AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              Ritz-Carlton Pune, and Conrad Pune. See the full list: Pune Luxury
              Hotels.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              ...
              Ritz-Carlton Pune, Blue Diamond - IHCL SeleQtions, and Quality Inn
              Mint. See the full list: Hotels near Aga Khan Palace.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
          ...
          <AccordionItem>
            ...
            <AccordionPanel pb={4}>
              Some of the most popular pet-friendly hotels in Pune are Marriott
              Suites Pune, Oakwood Residence Naylor Road Pune, and NewLeaf
              Hotel. See the full list: Pet Friendly Hotels in Pune.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
            ...
            <AccordionPanel pb={4}>
              Marriott Suites Pune, The Ritz-Carlton Pune, and Conrad Pune have
              a spa and received excellent reviews from travellers in Pune. See
              the full list: Pune Spa Resorts.
            </AccordionPanel>
          </AccordionItem>
          <AccordionItem>
            <h2>
