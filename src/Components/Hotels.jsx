...
const Hotels = () => {
    ...
    const handleChange = (e) => {
        ...
        if (e.target.value === "lthr") {
            list.sort((a, b) => { return Number(a.rating) - Number(b.rating) });
        }
        else if (e.target.value === "htlr") {
            list.sort((a, b) => { return Number(b.rating) - Number(a.rating) });
        }
        if (e.target.value === "lthp") {
            list.sort((a, b) => { return Number(a.price) - Number(b.price) });
        }
        else if (e.target.value === "htlp") {
            list.sort((a, b) => { return Number(b.price) - Number(a.price) });
        }
    }
    useEffect(() => {
                            ...
                            {list.map((hotel, ind) => {
                                ...
                                return <div key={hotel.id} className={styles.hotel}>
                                    ...
                                    <div className={styles.aboutHotelDiv}>
                                        <div className={styles.hotelName}>{ind + 1}.{hotel.name}</div>
                                            ...
                                            <div className={styles.description}>
                                                <div className={styles.RatePicDiv}>
                                                    ...
                                                    {hotel.ratePic.map((ele) => (
                                                        <img src={ele.src} key={ele.id} alt="rate-pic" className={styles.ratingPic} />
                                                    ))}
                 ...
                 <div className={styles.sightDiv}>
                    {sightList.map((sight)=>(
                        ...
                        <div key={sight.id} className={styles.sightInd}>
                            <img src={sight.srcImg} className={styles.imgSight} alt="sight-pic" />
                            <p>{sight.name}</p>
                        </div>
                    ))}
                 </div>
            ...
            <div className={styles.faq}>
                ...
                <Accordion allowToggle width="xxl">
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Treebo Trip Punest Hotel, 
                        Treebo Trend Chetan Executive, 
                        and OYO 9196 Suyog Inn are some of the most popular hotels 
                        for travellers looking to stay near Dagadusheth Halwai Ganapati Temple.
                         See the full list: Hotels near Dagadusheth Halwai Ganapati Temple.
                        </AccordionPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        The Corinthians Resort & Club, Atmantan Wellness Resort,
                         and Green Gate Resort are all popular resorts for travellers staying in Pune. 
                         See the full list: Pune Resorts.
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem>
                        <h2>
                        ...
                        <AccordionPanel pb={4}>
                        Popular hotels close to Sinhagad Fort include Mantra Resort Pune, 
                        Centurion Spring Hills Holiday Resort, and Ambrosia Resort & Spa. See the full list: 
                        Hotels near Sinhagad Fort.
                        </AccordionPanel>
                    </AccordionItem>
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Popular luxury hotels in Pune include Marriott Suites Pune, 
                        The Ritz-Carlton Pune, and Conrad Pune. See the full list:
                         Pune Luxury Hotels.
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Popular cheap hotels in Pune include Blue Diamond - IHCL SeleQtions, 
                        Hotel Shree Panchratna, and Hotel Shreyas. See the full list:
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        A few of the most popular hotels near Aga Khan Palace are The Ritz-Carlton Pune, Blue Diamond -
                         IHCL SeleQtions, and Quality Inn Mint. See the full list: 
                         Hotels near Aga Khan Palace.
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem>
                        <h2>
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Some of the most popular pet-friendly hotels in Pune are Marriott Suites Pune, 
                        Oakwood Residence Naylor Road Pune, and NewLeaf Hotel. See the full list:
                    ...
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Marriott Suites Pune, The Ritz-Carlton Pune, 
                        and Conrad Pune have a spa and received excellent reviews from travellers in Pune. See the full list:
                         Pune Spa Resorts.
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem>
                        ...
                        <AccordionPanel pb={4}>
                        Marriott Suites Pune, The Ritz-Carlton Pune, and Conrad Pune received great reviews
                         from travellers looking for a romantic hotel in Pune. See the full list: 
                         Romantic Hotels in Pune.
                        </AccordionPanel>
                    </AccordionItem>
                    <AccordionItem>
                        <h2>
                        ...
                        <AccordionPanel pb={4}>
                        Marriott Suites Pune, The Ritz-Carlton Pune, and Conrad Pune all received great
                         reviews from families travelling in Pune. See the full list: 
                         Family Hotels in Pune.
                        </AccordionPanel>
                    </AccordionItem>
                </Accordion>
            </div>
