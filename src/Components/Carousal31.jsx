    ...
    <div style={{ margin: "40px" }}>
      <Slider {...settings}>
        ...
        <div>
          ...
          />
          <div className={homepage.c_text}>
            Two Night Tiger Safari Experience at Tadoba National Park &Transfers
            From Nagpur from $575 per adult
          </div>
        </div>
        <div>
          <Img
        ...
        <div>
          ...
          />
          <div className={homepage.c_text}>
            Tadoba Tiger Reserve Tour Of India{" "}
          </div>
        </div>
        <div>
          <Img
          ...
          />
          <div className={homepage.c_text}>
            Wildlife Safari in Bandhavgarh, Kanha, Pench & Tadoba Andhari
            National Parks{" "}
          </div>
        </div>
        <div>
