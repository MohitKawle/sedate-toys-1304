    ...
    <>
      ...
      <div>
          ...
          <div className={homepage.search}>
            <div className={homepage.div_flex}>
              <img
                ...
                src="https://th.bing.com/th/id/OIP.LoM20QQiY8vmmGmCBwUmwgHaHa?pid=ImgDet&rs=1"
                alt=""
              />
        ...
        <div className={homepage.way_nagpur}>
          <div className={homepage.ways_to1}>Ways to tour Pune District</div>

          <div className={homepage.book_this}>
            Book these experiences for a close-up look at Nagpur District.
          </div>
          <div className={homepage.carousal}>{<Carousel31 />}</div>
        </div>
